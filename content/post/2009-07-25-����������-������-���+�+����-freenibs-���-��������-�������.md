---
title: Очистка базы биллинга freeNIBS от данных старше 3-х месяцев
author: wel
type: post
date: 2009-07-25T10:53:20+00:00
url: /billing/очистка-базы-биллинга-freenibs-от-данных-стар
short-url:
  - http://bit.ly/fiyAww
wp-syntax-cache-content:
  - |
    ...
    &nbsp;
    &nbsp;
    <span style="color: #666666;">//очищаем таблица actions</span>
                QSqlQuery query<span style="color: #008000;">&#40;</span><span style="color: #FF0000;">&quot; DELETE FROM `actions` WHERE `start_time`&lt;FROM_UNIXTIME(UNIX_TIMESTAMP(NOW() )-15592000); &quot;</span><span style="color: #008000;">&#41;</span><span style="color: #008080;">;</span>
    ...
    &nbsp;
                QSqlQuery query1<span style="color: #008000;">&#40;</span><span style="color: #FF0000;">&quot; OPTIMIZE TABLE `actions`; &quot;</span><span style="color: #008000;">&#41;</span><span style="color: #008080;">;</span>
    ...
    <span style="color: #666666;">//очищаем таблица updown</span>
                QSqlQuery query4<span style="color: #008000;">&#40;</span><span style="color: #FF0000;">&quot; DELETE FROM `updown` WHERE `time`&lt;FROM_UNIXTIME(UNIX_TIMESTAMP(NOW() )-15592000); &quot;</span><span style="color: #008000;">&#41;</span><span style="color: #008080;">;</span>
    ...
    &nbsp;
                QSqlQuery query5<span style="color: #008000;">&#40;</span><span style="color: #FF0000;">&quot; OPTIMIZE TABLE `updown`; &quot;</span><span style="color: #008000;">&#41;</span><span style="color: #008080;">;</span>
                query5.<span style="color: #007788;">clear</span><span style="color: #008000;">&#40;</span><span style="color: #008000;">&#41;</span><span style="color: #008080;">;</span>
    &nbsp;
...
---
Очистка базы биллинга freeNIBS от данных старше 3-х месяцев, хотя можно и больше оставить, можно и меньше.
  
Дело в том, что база actions разрастается &#8212; выборка медленее, мускулу тяжелее)))
  
15592000 &#8212; это число в секундах, почти 59 дней)))
